...
export default function CallUI({
    ...
    useEffect(() => {
        ...
        channel
            ...
            .catch((err) => {
                console.error("Chat channel failed to connect", err);
            ...
            <div className="flex flex-1 min-h-0">
                ...
                <div className="w-[340px] shrink-0 flex flex-col border-l border-white/8 bg-[#0a0a0b]">
                    ...
                    <div className="flex-1 min-h-0 overflow-hidden">
                        <div className="px-4 py-3 border-b border-white/10 bg-[#09090a] text-xs uppercase tracking-[0.18em] text-stone-400">
                            {activeTab === "chat" ? "Interview Chat" : "AI Interview Questions"}
                        </div>
                        {activeTab === "chat" ? (
                            chatError ? (
                                <div className="flex flex-col items-center justify-center h-full px-6 text-center gap-3">
                                    <p className="text-sm text-stone-300">Unable to connect to chat.</p>
                                    <p className="text-xs text-stone-500">{chatError}</p>
                                </div>
